...
#
# Time-stamp: <2012-08-03 12:19:57 (mkmccjr)>
...
module MyPlotStyles
  ...
  def minion_style(t = FigureMaker.default)
    t.tex_preview_preamble += '
%% Minion and Myriad fonts.  For some reason, myriad has to come first...
%%
\usepackage[sf,lining]{myriad}
\DeclareMathAlphabet{\mathsf}{LY1}{pmyx}{m}{n}
\DeclareMathAlphabet{\mathbfss}{LY1}{pmyx}{sb}{n}
%
